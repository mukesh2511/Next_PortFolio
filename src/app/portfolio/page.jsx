    ...
    >
      <div className="h-[600vh] relative" ref={ref}>
        ...
        <div className="sticky top-0 flex h-screen gap-4 items-center overflow-hidden">
          <motion.div style={{ x }} className="flex">
            <div className="w-screen h-screen flex items-center justify-center bg-gradient-to-r from-purple-300 to-red-300"></div>
            {items.map((item) => (
              <div
              ...
              >
                <div className="flex flex-col gap-8 text-white">
                  ...
                  <div className="relative w-80 h-56 md:w-96 md:h-64 lg:w-[450px] lg:h-[300px] xl:w-[550px] xl:h-[420px]">
      ...
      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center ">
        ...
        <div className="relative">
          ...
          <Link
            href={"/contact"}
            className="w-16 h-16 md:w-28 md:h-28 absolute top-0 bottom-0 right-0 left-0  m-auto bg-black text-white rounded-full flex justify-center items-center"
          >
            Hire Me
          </Link>
        </div>
